...
\begin{document}
	...
	\begin{itemize}
		...
		\item $G$ gruppo finito. $\rho$ rappresentazione irriducibile e fedele. Allora $Z(G)$ è ciclico.
		
		\item $g \in G$ elemento di ordine $2$ allora si ha $\chi_\rho(g) \in \bbZ$ e inoltre $\chi_\rho(g) \equiv \chi_\rho(e) (2)$. \\
			$g \in G$ elemento di ordine $3$ coniugato all'inverso. Allora $\chi_\rho(g) \in \bbZ$ e inoltre $\chi_\rho(g) \equiv \chi_\rho(e) (3)$.
	\end{itemize}
\end{document}
